...
package com.mesmer.tensorflow.lite.classification;
...
public abstract class Classifier {
  ...
  protected Classifier(Context context, Device device, int numThreads) throws IOException {
    Log.i(TAG, "Starting a Tensorflow Lite Image Classifier.");
    labels = loadLabelList(context);


    tfliteModel = loadModelFile(context);
    Log.i(TAG, "Created2 a Tensorflow Lite Image Classifier.");
    ...
    Log.i(TAG, "Created3 a Tensorflow Lite Image Classifier.");
  ...
  private List<String> loadLabelList(Context context) throws IOException {
    Log.i(TAG, "loadLabelList a Tensorflow Lite Image Classifier.");
    ...
    while ((line = reader.readLine()) != null) {
      Log.i(TAG, "loadLabelList a Tensorflow Lite Image Classifier." + line);
  ...
  private MappedByteBuffer loadModelFile(Context context) throws IOException {
    Log.i(TAG, "loadModelFile a Tensorflow Lite Image Classifier." + getModelPath());
    File file = new File(getLabelPath());
    Log.i(TAG, "loadModelFile2 a Tensorflow Lite Image Classifier." + file.exists());
